...
/// Upload limits from contract §4. Checked client-side so an oversized photo
/// fails immediately rather than after a slow upload — the server enforces them
/// too, and that is the boundary that actually matters.
const int kMaxUploadBytes = 5 * 1024 * 1024;
const List<String> kAcceptedImageExtensions = ['jpg', 'jpeg', 'png', 'webp'];
