...
class PaginationFooter extends StatelessWidget {
      ...
      child: Row(
        ...
        children: [
          Text(
            ...
            style: TextStyle(fontSize: 13.sp, color: palette.textTertiary, fontWeight: FontWeight.w600),
          ),
          Row(
            children: [
              _arrowBtn(context, Icons.chevron_left, isActive: currentPage > 1, onTap: () {
  ...
  Widget _arrowBtn(BuildContext context, IconData icon, {required bool isActive, required VoidCallback onTap}) {
    final palette = context.palette;
    return GestureDetector(
      onTap: onTap,
      child: Container(
